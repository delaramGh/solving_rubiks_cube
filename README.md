This project includes a Cube class that represents the state of a Rubik's cube (cube.cpp), with its methods corresponding to the possible moves the cube can make at each step. 
